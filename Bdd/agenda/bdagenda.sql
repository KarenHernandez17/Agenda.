...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2023 a las 08:09:35
...
(2, '2', '2', '2', 'Gramatica', '5J', 'LSC', 2),
(3, '3', '3', '3', 'Las NIF\'S', '5J', 'LSC', 3),
(4, '4', '4', '4', 'simple past', '5J', 'LSC', 4),
(5, '5', '5', '5', 'La gran M', '5J', 'LSC', 5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `t-grupos`
--

CREATE TABLE `t-grupos` (
...
(1, 'karen.hernandez68@unach.mx', 'hola'),
(2, 'lisandro12@gmail.com', '12345'),
(3, 'maria12@gmail.com', '12345'),
(4, 'abad11@gmail.com', '12345'),
(5, 'carolina@gmail.com', '12345');
...
--
-- Indices de la tabla `t-grupos`
--
ALTER TABLE `t-grupos`
...
--
-- AUTO_INCREMENT de la tabla `t-grupos`
--
ALTER TABLE `t-grupos`
